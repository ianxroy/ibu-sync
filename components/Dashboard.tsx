...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  }, [status, grades.length, onTriggerWrapUp]);
                ...
                {honorForecasts.map((h, i) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-end gap-1">
                      <div
                        className={`px-2 py-1 rounded-lg text-[9px] font-black uppercase tracking-wide ${h.status.includes("Impossible") ? "bg-red-100 text-red-600" : "bg-emerald-100 text-emerald-600"}`}
                      >
                        {h.status}
                      </div>
                      {h.probability > 0 && (
          ...
          return (
            ...
            >
              <button
                ...
                className="w-full p-4 flex items-center justify-between hover:bg-white/40"
              >
                  ...
                  {items.map((g, i) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <input
                          type="number"
                          className="w-12 h-9 rounded-lg bg-slate-50 border border-slate-200 text-center text-xs font-bold text-slate-600"
                        ...
                        />
                        <div className="flex flex-col items-center justify-center text-white bg-blue-600 w-20 h-9 rounded-lg shadow-md">
